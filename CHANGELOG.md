...
>
> **Último build verificado:** **120 jobs**, 0 errores, 0 warnings, 0 sorrys (2026‑08‑31).
...
mí. Build **120 jobs**, **57 `sondeos/`**. Proyectado en **§3.31**.
...
`#print axioms`; recompilado también por mí. Build **120 jobs** (tras promover `EvalPredPrf`), **57 `sondeos/`**. Proyectado en
**§3.30**.
