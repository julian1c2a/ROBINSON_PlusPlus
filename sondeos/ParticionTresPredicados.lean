...
#print axioms PilotoParticion.pcc_isTCB_tracked
#print axioms PilotoParticion.pcc_isTsCB_tracked
#print axioms PilotoParticion.pcc_wfAllT_tracked
#print axioms PilotoParticion.pcc_wfAllTs_tracked
#print axioms PilotoParticion.prf_pairOk_gen
#print axioms PilotoParticion.okT_tcodesT
#print axioms PilotoParticion.okTs_lcodesTs
#print axioms PilotoParticion.prf_isTCB_subCodesT
#print axioms PilotoParticion.prf_isTsCB_subCodesTs
#print axioms PilotoParticion.pcc_isTCB_subCodesT
#print axioms PilotoParticion.pcc_isTsCB_subCodesTs

#print axioms PilotoParticion.pcc_isFormCodeB_pure
#print axioms PilotoParticion.pcc_wfAllF_tracked
#print axioms PilotoParticion.pcc_wfAllTgen_tracked
#print axioms PilotoParticion.pcc_wfAllTsgen_tracked
#print axioms PilotoParticion.pcc_isFCB3_tracked
#print axioms PilotoParticion.okF_fcodes
#print axioms PilotoParticion.prf_isFCB3_fcodes
#print axioms PilotoParticion.pcc_isFCB3_fcodes

-- ⚠️ NO VACUIDAD: los testigos son CONCRETOS y computables. El de una fórmula con
-- símbolos contiene `nil` (= `termsCodeM []`) en la lista de LISTAS: el disyunto
-- DESNUDO de `isTermsCodeB` es obligatorio, igual que en A3.
#eval (PilotoParticion.tcodesT (Term.func "f" [.var 0])).length     -- 2
#eval (PilotoParticion.lcodesT (Term.func "f" [.var 0])).length     -- 2
#eval (PilotoParticion.fcodes  (Formula.atom "p" [Term.func "f" [.var 0]])).length   -- 1
#eval (PilotoParticion.ftcodes (Formula.atom "p" [Term.func "f" [.var 0]])).length   -- 2
#eval (PilotoParticion.flcodes (Formula.atom "p" [Term.func "f" [.var 0]])).length   -- 2
#eval (PilotoParticion.fcodes
  (Formula.impl (Formula.eq (.var 0) (.var 1)) Formula.bottom)).length               -- 3
example : List.Mem nil (PilotoParticion.flcodes (Formula.atom "p" [Term.var 0])) :=
