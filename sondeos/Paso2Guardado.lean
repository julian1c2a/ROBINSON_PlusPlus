/-
# P2G_gamma — EL PASO INDUCTIVO `forall` de `pcc_eval_substfc` CON GUARDA `hasWit s`,
# reescrito ENTERO en `PrfH Gamma` con `Gamma = [hasWit s]`.
#
...
# Lo NUEVO esta en la seccion `S_Nuevo` / namespace `P2G`, al final del fichero.
#
...
#
#   lake env lean Probe/P2G_gamma.lean
-/
