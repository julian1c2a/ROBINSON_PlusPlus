/- # ENS_dosfases — EL ENSAMBLAJE de `pcc_eval_substfc` por la via (B) DOS FASES.

   Hipotesis de trabajo medida aqui: la induccion fuerte que falta es **SOLO sobre el sort
   FORMULA**; la parte de TERMINO/LISTA entra como LEMA EXTERNO (`pcc_eval_substtc'` /
   `pcc_eval_substtsc'` de `sondeos/EvalSubsttc.lean`).

   ⚠️ CERO `axiom` de Lean, cero `sorry`. Autocontenido (`import ROBINSON_PlusPlus.Meta`).

       lake env lean Probe/ENS_dosfases.lean
-/
...
#print axioms ENS.hPHI
#print axioms ENS.PHI_use
#print axioms ENS.IH_at
#print axioms ENS.prf_isFormCodeE2_of_In
#print axioms ENS.rama_bot
#print axioms ENS.rama_atom
#print axioms ENS.rama_eq
#print axioms ENS.rama_bin
#print axioms ENS.rama_un
#print axioms ENS.clauses_imp
#print axioms ENS.PHI_step
#print axioms ENS.DESCENSO_imp
#print axioms ENS.pcc_eval_substfc_modulo_8
#print axioms ENS.casoBot
#print axioms ENS.casoBin5
#print axioms ENS.casoBin7
#print axioms ENS.casoBin8
#print axioms ENS.casoHasWitLift
#print axioms ENS.pcc_substfc_ter_dot
#print axioms ENS.pcc_substfc_atom_dot
#print axioms ENS.casoEq
#print axioms ENS.casoAtom
#print axioms ENS.paso2_caso_un_conj
#print axioms ENS.casoUn6
#print axioms ENS.casoUn9
#print axioms ENS.DESCENSO_substfc
#print axioms ENS.pcc_eval_substfc
#print axioms ENS.pcc_eval_substfc_wit
#print axioms ENS.prf_isFormCodeE2_str
#print axioms ENS.CRIT_E2_rejects_varc
#print axioms ENS.CRIT_E2_rejects_funcc
#print axioms ENS.CRIT_isFC1_rejects_varc
#print axioms ENS.bridge_isTC1
#print axioms ENS.bridge_argsIn
#print axioms ENS.bridge_hasWit_SinWTs
#print axioms ENS.bridge_hasWit_DescMutua
#print axioms ENS.bridge_evalSubstfcCode_Paso2

#check @ENS.hPHI
#check @ENS.PHI_step
#check @ENS.DESCENSO_substfc
#check @ENS.pcc_eval_substfc
#check @ENS.pcc_eval_substfc_wit
#check @ENS.hasWitF
#check @ENS.isFC1
#check @ENS.GUARD
#check @ENS.isFormCodeE2