...
>
> **Build 145 jobs · 0 sorrys · Lean v4.31.0** ✅ **VERDE** (2026‑09‑10h).
>
...
| Declaraciones `axiom` de Lean | **6** (2026‑09‑10g, `d3` RETIRADO): 3 esquemas de inducción `Full/`, TFA `Block8`, 2 anclas de codificación. Inventario en **`AXIOMS.md`**. Ninguna es un `sorry` (ADR-010) |
...
| Build status | ✅ Passing (**145 jobs**, **131 módulos**, 0 errores, **0 warnings**, **0 sorry** — verificado con el `check-sorry.bash` reparado —, **5** `axiom` de Lean, Lean v4.31.0, 2026-09-10h) |
