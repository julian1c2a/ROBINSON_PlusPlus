...
| Metric | Value |
|--------|-------|
| Total modules | 39 (Minimal/ 11 + Meta/ 17 [Godel, Provability, Incompleteness, Hilbert, HilbertSeq, CodeArith, SubstArith, StepArith, CheckArith, Representability, Necessitation, Diagonal, CodeDistinct, Induction, ProofChain, DerivCond, Representability2] + Full/ 11) |
| Modules sin sorry | 39 / 39 ✅ |
