...
| Metric | Value |
|--------|-------|
| Total modules | 42 (Minimal/ 11 + Meta/ 20 [Godel, Provability, Incompleteness, Hilbert, HilbertSeq, CodeArith, SubstArith, StepArith, CheckArith, Representability, Necessitation, Diagonal, CodeDistinct, Induction, ProofChain, DerivCond, Representability2, Reflection, DiagonalTwo, GodelTwo] + Full/ 11) |
| Modules sin sorry | 42 / 42 ✅ |
