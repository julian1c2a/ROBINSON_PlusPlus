...
> [`doc/REFERENCE-Full.md`](doc/REFERENCE-Full.md). Para **`Meta/`** (76 módulos) se adopta la **vista
...
### `cuarentena/` — 6 módulos FUERA del build
...
```bash
lake build                              # build completo (112 jobs a 2026-08-23)
