...
> [`doc/REFERENCE-Full.md`](doc/REFERENCE-Full.md). Para **`Meta/`** (72 módulos) se adopta la **vista
...
### `cuarentena/` — 10 módulos FUERA del build
...
```bash
lake build                              # build completo (108 jobs a 2026-08-23)
