...
REFERENCE, `AI-GUIDE.md` §0.5). **83 módulos fuente** (Minimal 11 + Meta 61 + Full 11) + barrels.
...
> Build verde **97 jobs**, 0 errores, **0 warnings, 0 sorrys** (2026-07-14, Lean v4.31.0). **83 módulos
> fuente** (Minimal 11 + Meta 61 + Full 11), **918 símbolos exportados**. **7 `axiom` de Lean** (tras
...
| [**Incompletitud**](doc/REFERENCE-Incompleteness.md) | Nivel D: Gödel I/II, D1–D3, Σ₁‑completitud provable (12‑A), ruta B dotada, **módulo A de `NegVerifier` (decodificador)** | §3.15–§3.22 |
