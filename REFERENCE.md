...
-- #print axioms = [propext, Classical.choice, Quot.sound]
-- OBSTRUCCIÓN pendiente: `tcFn L =eq termCode L` sólo vale si L YA es código literal (numeral/cons/nil);
--   para L=runFn nil p el cierre inductivo debe ir sobre la ESTRUCTURA de la lista de conclusiones ("la bestia").
```
