...
| 3–5 | `Hilbert.lean` · `HilbertDeduction.lean` · `HilbertSeq.lean` | F0/F1: `Prfᵢ`/`Prf` + puentes (`dne` aislado); deducción finitaria `PrfH`; `checkProof`, `Dem`, `dem_tracks` |
...
> **3 `axiom` de Lean** (tras F7a, [ADR‑026](DECISIONS.md) y la retirada de Ax‑P): 2 esquemas de inducción (`Full/`)
