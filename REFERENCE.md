...
| `Meta/ProofChain.lean` | `…Meta.ProofChain` | `Meta.CheckArith`, `Full.Lists` | 🔄 Nivel D real R1–R3 (hacia D2/D3): verificador estructural `runFn` + `chainOk`/`lineOk`/`allIn` — compositividad/debilitamiento/composición/monotonía |
