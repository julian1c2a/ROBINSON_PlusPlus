...
> → reglas `ind`/`listInd`).
> **Ficheros `.lean`:** la cadena `Meta/` (76 módulos en el build, barrel
> [Meta.lean](../ROBINSON_PlusPlus/Meta.lean)) más los **6 módulos en `cuarentena/`**, que **NO están
...
>
> **Build 112 jobs · 98 módulos activos** (Minimal 11 + Meta 76 + Full 11) **+ 6 en `cuarentena/`
