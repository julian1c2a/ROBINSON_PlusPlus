...
> → reglas `ind`/`listInd`).
> **Ficheros `.lean`:** la cadena `Meta/` (72 módulos en el build, barrel
> [Meta.lean](../ROBINSON_PlusPlus/Meta.lean)) más los **10 módulos en `cuarentena/`**, que **NO están
...
>
> **Build 108 jobs · 94 módulos activos** (Minimal 11 + Meta 72 + Full 11) **+ 10 en `cuarentena/`
