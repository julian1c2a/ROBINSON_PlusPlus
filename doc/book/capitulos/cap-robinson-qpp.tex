...
Uno de los siete de listas merece mirarse ahora, porque será el protagonista de la Parte~\ref{parte:noescrito}:
...
tercera razón, que desarrollará \capfuturo{por qué la inducción no es opcional para Gödel~II}: para Gödel~II la inducción \textbf{no es opcional} —
...
\noindent Tres veces más maquinaria que aritmética. Ése es, medido, \textbf{el precio de que una teoría
pueda hablar de su propia sintaxis}, y lo desglosa \capfuturo{cómo funciona el verificador}.
...
\adr{015} —ver \capfuturo{definir en vez de axiomatizar}— leído al revés, y significa que la elección de axiomas dejó de ser
