...
\include{capitulos/cap-hilbert-y-godel}
\include{capitulos/cap-que-hay-que-construir}
\include{capitulos/cap-los-lenguajes}
\include{capitulos/cap-minimo-de-lean}
...
\include{capitulos/cap-objeto-y-meta}          % 6 ✅
...
% =============================================================================
\include{capitulos/cap-codificar-estructuras}  % 8  ✅
\include{capitulos/cap-codigos-de-sintaxis}    % 9  ✅
...
% =============================================================================
\include{capitulos/cap-autorreferencia}            % 12 ✅
\include{capitulos/cap-godel-i}                    % 13 ✅
\include{capitulos/cap-la-mitad-que-falta}         % 14 ✅
\include{capitulos/cap-condiciones-derivabilidad}  % 15 ✅
...
% =============================================================================
\include{capitulos/cap-muro-substfc}               % 18 ✅
...
\include{capitulos/cap-codigos-como-numerales}     % 22 ✅
...
\include{capitulos/ap-glosario}
\include{capitulos/ap-notacion}
\include{capitulos/ap-licencia}
